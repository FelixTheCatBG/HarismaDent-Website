      ...
      <section  style="background-color:#fff;padding-bottom:30px;color:#3181bb">
       <div class="container" >
            <div class="">
                ...
                <div class="col-md-8 text-justify" id="only" style=""> 
                    ...
                    <p>
                      ...
                      <div class="col-md-12" style="padding-left: 0px;">
                        ...
                        <label for="Date">Booking Date:</label> <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ForeColor="Red" ErrorMessage="Please fill in required fields"
                            ControlToValidate="TextBox1" ValidationGroup="save" />
                               <asp:TextBox ID="TextBox1" CssClass="form-control datesmall" runat="server" style="float:left;width=50%;" ReadOnly = "false"></asp:TextBox>
                                 <img style="float:left;" src="img/calender.png" />
                       <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="*"
                            ControlToValidate="Date" ValidationGroup="save" /><br />
                        <asp:TextBox ID="Date" runat="server" Width="100%" CssClass="form-control"/><br />--%>
                               </div>
                      ...
                      <%--  Subject:
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ForeColor="Red" ErrorMessage="Please fill in required fields"
                            ControlToValidate="Details" ValidationGroup="save" /><br />
                        <asp:TextBox ID="Details" runat="server" 
                                TextMode="MultiLine" Rows="5" Width="100%" CssClass="form-control" />
                    
                    <p>
                        <asp:Button ID="btnSubmit" runat="server" Text="Send" 
                                    OnClick="Button1_Click" ValidationGroup="save" CssClass="btn btn-success" style="float:right;margin-top:15px;" />
                    </p>
                ...
                <div class="col-md-4 text-justify">
                    <div class="service-box">
                        ...
                        <p>
                          ...
                          For your convenience, you can book online appointment for our clinic here.
                            
                       <br />
                            It is possible that the desired time is already reserved, so we will contact you shortly for confirmation !
                            </p> <p>
